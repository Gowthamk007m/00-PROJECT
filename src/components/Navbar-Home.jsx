...
const Navbar = () => {
  ...
  return (
<header className="relative  p-0 w-full px-15 pb-4  bg-[#f3f3f313] md:px-15 border-b border-gray-300">
      ...
      <div className="mx-auto flex flex-wrap items-center justify-between pt-4">
        ...
        <div className="hidden md:flex md:w-auto">
          <ul className="text-md flex flex-row space-x-1 rounded-3xl p-0 px-1 font-medium">
            {navItems.map((item) => (
              <li key={item.name}>
                <a
                  href={item.link}
